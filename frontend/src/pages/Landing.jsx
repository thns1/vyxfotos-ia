...
export default function Landing() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen text-ivory font-sans selection:bg-champagne selection:text-obsidian relative overflow-x-hidden bg-[#050508]">
      ...
      {/* LOGIN GATE — bloqueia acesso até o usuário fazer login */}
      {!authLoading && !user && (
        <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center px-6 bg-[#050508]">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1600607686527-6fb886090705?auto=format&fit=crop&q=80')] bg-cover bg-center opacity-10 filter blur-[3px]"></div>
          <div className="absolute inset-0 bg-gradient-to-b from-[#050508]/60 to-[#050508]/95"></div>

          <div className="relative z-10 w-full max-w-md text-center space-y-8 bg-[#0a0a0e]/80 backdrop-blur-3xl p-10 md:p-14 rounded-[2.5rem] border border-white/10 shadow-[0_0_80px_rgba(201,168,76,0.08)]">
            <div>
              <p className="text-xl md:text-2xl font-black text-ivory tracking-tight mb-1">
                Vyxfotos<span className="text-champagne">.</span>IA
              </p>
              <p className="text-xs font-mono tracking-[0.25em] uppercase text-ivory/30">Acesso Exclusivo</p>
            </div>
            ...
            <button
              onClick={doLogin}
              className="w-full flex items-center justify-center gap-3 py-4 bg-white text-[#1a1a1a] font-bold rounded-2xl shadow-lg hover:bg-ivory/90 active:scale-[0.98] transition-all duration-200 text-sm tracking-wide"
            >
            ...
            <p className="text-[10px] text-ivory/20 font-mono leading-relaxed">
              Ao continuar, você concorda com nossos{' '}
              <button onClick={() => { navigate('/privacidade'); }} className="underline hover:text-ivory/40 transition-colors">
