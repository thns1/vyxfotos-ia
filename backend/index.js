...
FRAMING (ABSOLUTE RULE — ZERO EXCEPTIONS): This is a waist-up portrait. The camera must be pulled back far enough so that: (1) the COMPLETE head with ALL hair is fully visible — top of head has at least 25% empty background above it; (2) ZERO cropping of the head, scalp, or hair at ANY edge of the frame; (3) the bottom of the frame cuts at hip/waist level; (4) the subject's ARMS ARE CROSSED in front of the body. If in doubt, zoom out more. The head must be fully centered vertically in the upper half of the image with generous space above it.
